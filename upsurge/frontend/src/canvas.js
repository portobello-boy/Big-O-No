    ...
    */
    componentDidMount() {
        ...
        for (let i = 0; i < gates.length; ++i) {
            ...
            gates[i].addEventListener('dragstart', (e) => this.dragStart(e));
            gates[i].addEventListener('click', (e) => console.log(e.target.id));
            gates[i].addEventListener('dragend', (e) => this.dragEnd(e));
        }
